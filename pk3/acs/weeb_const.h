...
#define WEEB_DEC_MULTIPLIER     30
#define WEEB_DEC_PLAYSOUND      31
#define WEEB_DEC_NOWEAPCHECK    32
#define WEEB_DEC_NOHEALTHCHECK  33
#define WEEB_DEC_NOARMORCHECK   34
#define WEEB_DEC_PICKUPFLASH    35
#define WEEB_DEC_CLASSCHECK     36
#define WEEB_DEC_SENTCHECK      37

#define WEEB_DEC_GETMESSAGES    0
#define WEEB_DEC_CHANGEMUS      1
#define WEEB_DEC_CHANGEMUSBACK  2
#define WEEB_DEC_PICKUPCHECK    3
...
SHIHONG SOUNDS:\n\
=========\n\
- Heidi Tabing ( www.youtube.com/user/AderuMoro - Going above and beyond the line of duty for Shihong's voice!)\n\
- All sounds are credited to their respective owner in SNDINFO.";
